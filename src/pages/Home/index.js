  ...
  return (
    <SafeAreaView style={{
      ...
      <View style={{
        ...
        <MyMenu onPress={() => navigation.navigate('Anggota')} img={require('../../assets/A3.png')} judul="Anggota" desc="Informasi data anggota" />
        <MyMenu onPress={() => navigation.navigate('Kegiatan')} img={require('../../assets/A1.png')} judul="Kegiatan" desc="Informasi data kegiatan" />
